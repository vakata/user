...
|[signToken](#vakata\user\userdatabasesigntoken)|Static sign token function. Signs and encrypts a given JWT using the set of rules provided in `init`.|
...
### vakata\user\UserDatabase::signToken
